                            ...
                            while($row_2_products=mysqli_fetch_assoc($query_2_products)){
                               $prod_id=$row_2_products['prod_id'];
                                ...
                                "<tr id='row-$prod_id'>
                                    ...
                                    <td><button type='button' id='update_btn-$prod_id' class='update_btn' data-value='book' data-id='$prod_id'>update</button></td>
                                    <td><button type='button' id='delete_btn-$prod_id' class='delete_btn' data-value='book' data-id='$prod_id'>delete</button></td>
                                </tr>";
                                $slno++;
                            }
