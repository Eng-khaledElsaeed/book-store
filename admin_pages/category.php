...
if(isset($_GET['search_value'])){
    ...
    $sql = "SELECT * FROM categories WHERE category_name LIKE '%$search_category%' or category_id LIKE '%$search_category%' or
    category_desc LIKE '%$search_category%' or category_status LIKE '%$search_category%'";
...
<body>
   <div class="dashboard_layout">
    ...
    <main class="main" style="padding:0px" >
        ...
        <div class="main_item category show">
            ...
            <div class="table">
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        $slno = $start_rec + 1;       
                        $query_1_categories=mysqli_query($conn,"SELECT * FROM category LIMIT $start_rec, $pagesize");
                            ...
                            while($row_1_categories=mysqli_fetch_assoc($query_1_categories)){
                               ...
                               $category_id=$row_1_categories['category_id'];
                                ...
                                "<tr id='row-$category_id'>
                                    ...
                                    <td><button type='button' id='update_btn-$category_id' class='update_btn' data-product-id='$category_id'>update</button></td>
                                    <td><button type='button' id='delete_btn-$category_id' class='delete_btn' data-product-id='$category_id'>delete</button></td>
                                </tr>";
                                $slno++;
                            }
